...
the various actions described in :ref:`library_reference:Assignment Methods` can be used.
...
A :keyword:`yield` will run a function (that must be marked as a "coroutine", see :ref:`coroutines:Coroutines`)
